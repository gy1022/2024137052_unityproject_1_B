...
public class TweenTest : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //transform.DORotate(new Vector3(0, 0, 180), 0.3f));         //Tween을 통해서 오브젝트는 Z축으로 0.3초동안 180도만큼 회전한다
        ...
        //transform.DOMoveX(5, 2f).SetEase(Ease.OutBounce).OnComplete(DeactivateObject);     //이동할 때 효과를 추가 시킬 수 있다.(Ease.OutBounce)
